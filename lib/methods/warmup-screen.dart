...
class Warmup_screen extends StatefulWidget {
  const Warmup_screen({Key? key}) : super(key: key);

  @override
  State<Warmup_screen> createState() => _warmup_screenState();
}

class _warmup_screenState extends State<Warmup_screen>  with TickerProviderStateMixin {
                    ...
                    children: [
                      Container(
                        ...
                        child: Text(
                          'W',
                          style: TextStyle(
                              color: HexColor('#3EA244').withOpacity(0.2),
                              fontSize: 60,
